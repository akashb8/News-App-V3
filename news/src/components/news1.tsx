        ...
        <div className="bg-white dark:bg-slate-900/30 border border-slate-200/40 dark:border-slate-900/60 rounded-3xl p-6 mb-8 shadow-sm">
          ...
          <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="flex-1">
              <div className="flex items-center space-x-2.5 overflow-x-auto py-2.5 no-scrollbar scroll-smooth">
                {categories.map((cat) => {
                  ...
                  return (
                    <button
                      ...
                      className={`px-5 py-2.5 rounded-full text-sm font-semibold tracking-wide transition-all duration-300 whitespace-nowrap cursor-pointer select-none flex items-center space-x-2 border ${
                        isActive
                          ? "bg-gradient-to-r from-violet-600 to-indigo-600 text-white shadow-md shadow-violet-500/20 border-transparent"
                          : "bg-slate-100 dark:bg-slate-900 text-slate-600 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-800 border-slate-200/40 dark:border-slate-800/40"
                      }`}
                    >
            ...
            {/* Search Input and Publisher Filters */}
              ...
              {uniqueSources.length > 0 && (
                <div className="relative w-full sm:w-auto">
                  <select
                    ...
                    className="w-full sm:w-48 appearance-none pl-4 pr-10 py-2.5 rounded-full border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 focus:outline-none focus:ring-2 focus:ring-violet-500/20 focus:border-violet-500 text-xs font-bold transition-all text-slate-600 dark:text-slate-300 cursor-pointer"
                  >
